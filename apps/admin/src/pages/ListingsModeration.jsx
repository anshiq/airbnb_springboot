...
const ACTIONS = [
  ...
  },
  {
    ...
    action: "DRAFT",
    cls: "text-yellow-700 hover:bg-yellow-50",
    needsReason: true,
  },
  {
    label: "Reject",
  ...
  },
  {
    label: "Suspend",
    action: "SUSPENDED",
    cls: "text-orange-700 hover:bg-orange-50",
    needsReason: true,
  },
];
...
export default function ListingsModeration() {
  ...
  function openModal(listing, actionObj) {
    setModal({
      ...
      needsReason: actionObj.needsReason,
          ...
          {modal.action !== "ACTIVE" && (
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">
                Reason{" "}
                {modal.needsReason && <span className="text-red-500">*</span>}
              </label>
              <textarea
                value={reason}
